export const consumables = {
    ...
    ice_resin: { name: 'Ice Resin', cost: 10, text: 'Adds ice damage to weapons attacks, but lowers attack speed.', load: 5, type:"buffs"},
    dark_resin: { name: 'Dark Resin', cost: 10, text: 'Adds dark damage to weapons attacks, but lowers range.', load: 5, type:"buffs"},
    light_resin: { name: 'Light Resin', cost: 10, text: 'Adds dark damage to weapons attacks, but lowers stunning.', load: 5, type:"buffs"},
    ...
    knife: { name: 'Knife', cost: 3, text: 'A light throwing weapon that distracts rather than damages the target', load: 1, type:"projectiles"},
